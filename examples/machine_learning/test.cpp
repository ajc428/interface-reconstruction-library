...
int main(int argc, char* argv[])
{
    ...
    //create_surface("test_surface_", -0.654848399024168, 0.655604026957474, 1.27533066017913 ,3.07118,1.01374,4.36249,-0.211589927988185, -0.272218428385744);
    //create_surface("test_surface",-0.320446,-0.496939,0.262045,2.33306,3.61892,6.03591,0.27547,0.245008);
    
    //data_generate(10000,0,2*3.1415,0,2*3.1415,0,2*3.1415,0.01,0.5,0.01,0.5,-0.5,0.5,-0.5,0.5,-0.5,0.5);

    auto t = IRL::trainer(1000, 90000, 0.0001, 6);
    t.load_train_data("fractions.txt", "loss.txt");
    t.load_test_data("fractions.txt", "loss.txt");
