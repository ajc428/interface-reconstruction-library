...
file = open("plicnet.h", "w")
print("/*! \\file plicnet.h", file=file)
...
print(" * Use generate_plicnet.py to generate this file for a given Pytorch model.", file=file)
print(" */\n", file=file)
...
print("inline void get_normal(const double* moments, double (&normal)[3]) {", file=file)
