        ...
        else
        {
          ...
          for (int ii = 0; ii < 3; ++ii)
          {
            for (int jj = 0; jj < 3; ++jj)
            {
              ...
              {
                fractions.push_back(local_liquid_volume_fraction(ii, jj, kk));
                fractions.push_back(local_liquid_centroid(ii, jj, kk)[0]);
                fractions.push_back(local_liquid_centroid(ii, jj, kk)[1]);
                fractions.push_back(local_liquid_centroid(ii, jj, kk)[2]);
              }
            }
          }
