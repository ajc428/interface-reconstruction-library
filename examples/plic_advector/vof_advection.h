...
#ifndef EXAMPLES_PLIC_ADVECTOR_VOF_ADVECTION_H_
#define EXAMPLES_PLIC_ADVECTOR_VOF_ADVECTION_H_
...
inline IRL::Vec3<double> getVelocity(const IRL::Pt& a_location, const Data<double>& a_U,
...
inline IRL::Vec3<double> getVelocity(const IRL::Pt& a_location, const Data<double>& a_U,
                             const Data<double>& a_V, const Data<double>& a_W) {
  return IRL::Vec3<double>(a_U.interpolate(a_location), a_V.interpolate(a_location),
