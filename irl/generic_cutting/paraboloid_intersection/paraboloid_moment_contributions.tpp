...
#ifndef IRL_GENERIC_CUTTING_PARABOLOID_INTERSECTION_PARABOLOID_MOMENT_CONTRIBUTIONS_TPP_
#define IRL_GENERIC_CUTTING_PARABOLOID_INTERSECTION_PARABOLOID_MOMENT_CONTRIBUTIONS_TPP_
...
class ParaboloidMomentArcIntegrator {
 public:
  ...
  ParaboloidMomentArcIntegrator(const AlignedParaboloid& a_paraboloid,
    ...
    switch (a_proj_dir) {
      case 0:
        integrand_m = MomentsIntegrandParaboloidArc<0>;
        norm_weight_m = face_normal_m[2] / face_normal_m[0];
        break;
      case 1:
        integrand_m = MomentsIntegrandParaboloidArc<1>;
        norm_weight_m = -face_normal_m[2] / face_normal_m[1];
        break;
      case 2:
        integrand_m = MomentsIntegrandParaboloidArc<2>;
...
#endif  // IRL_GENERIC_CUTTING_PARABOLOID_INTERSECTION_PARABOLOID_MOMENT_CONTRIBUTIONS_TPP_