...
#ifndef IRL_HELPERS_HELPER_TPP_
#define IRL_HELPERS_HELPER_TPP_
...
inline double clipBetween(const double a_smallest_value, const double a_value,
  ...
  if (a_value > a_largest_value) {
    return a_largest_value;
  } else if (a_value < a_smallest_value) {
    return a_smallest_value;
  }
  return a_value;
}
