...
#ifndef IRL_INTERFACE_RECONSTRUCTION_METHODS_ELVIRA_H_
#define IRL_INTERFACE_RECONSTRUCTION_METHODS_ELVIRA_H_
...
#endif // IRL_INTERFACE_RECONSTRUCTION_METHODS_ELVIRA_H_
