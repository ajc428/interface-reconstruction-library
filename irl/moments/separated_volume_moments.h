...
#ifndef IRL_MOMENTS_SEPARATED_VOLUME_MOMENTS_H_
#define IRL_MOMENTS_SEPARATED_VOLUME_MOMENTS_H_
...
class SeparatedMoments<Volume>
    : public SeparatedMomentsCommon<SeparatedMoments<Volume>, Volume> {
